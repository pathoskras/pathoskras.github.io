...
`;
function drawBannerPage(text, text2) {
    if (text2)
        text += text2;
...
Object.keys(images).forEach(function (image) {
    const drawingData = images[image];
...
function terms() {
    ...
    div
        .append('p')
        .text('From the MSD Manual Consumer Version (Known as the Merck Manual in the US and Canada and the MSD Manual in the rest of the world), edited by Sandy Falk. Copyright 2022 by Merck Sharp & Dohme Corp., a subsidiary of Merck & Co., Inc., Kenilworth, NJ. Available at http://www.msdmanuals.com/home. Accessed Feb 2022.')
        .styles({
        'font-weight': 100,
        'font-size': '10px',
    });
